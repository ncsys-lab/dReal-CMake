...
// #define CAV26_FILTER_SYMMETRIES
#ifdef CAV26_FILTER_SYMMETRIES
#define CAV26_VARNAME_PARSER          CAV26_DRH_PARSER
#define CAV26_MATCH_ACROSS_TIME_ONLY  false
#define CAV26_MATCH_ACROSS_LOGIC_ONLY false
