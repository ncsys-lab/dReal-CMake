...
f(a,b,c) /\ g(a,b,c) gives conflict?  can take 3 minutes
f(a,b,c) /\ h(a,b,c) gives conflict?  can take 0.1 sec

----

INPUT SMT-LIB .smt2:  .... (a>3) /\ !(a<4) ....
BoolAbstract =>  `P \/ Q \/ R`
Guess:  {P, !Q, !R}
TheoryCheck?  =>  (a=b) /\ !(a=c) /\ !(b=c)
TheoryModel: a=1, b=1, c=2
...
a.smt2:
    (define-const a Real [0, 10])

b.smt2:
    (define-const a Real [0, 100])

THEORY LEMMA:
(a>3) \/ (a<4)
-> "for all a (reals), (a>3) \/ (a<4) MUST BE TRUE. ie. it is a tautology within the theory of real arithmetic."
